    ...
    private void encodeContentsFromZXingIntent(Intent intent) {
        ...
        if (format == null || format == BarcodeFormat.QR_CODE) {
            ...
            if (data != null && !data.isEmpty()) {
                ...
                title = "contents_text";//activity.getString(R.string.contents_text);
            }
        }
    }
        ...
        switch (type) {
            ...
            case Contents.Type.EMAIL:
                ...
                if (emailData != null) {
                    ...
                    title = "contents_email";//activity.getString(R.string.contents_email);
                }
                break;
            ...
            case Contents.Type.PHONE:
                ...
                if (phoneData != null) {
                    ...
                    title = "contents_phone";//activity.getString(R.string.contents_phone);
                }
                break;
            ...
            case Contents.Type.SMS:
                ...
                if (smsData != null) {
                    ...
                    title = "contents_sms";//activity.getString(R.string.contents_sms);
                }
                break;
            ...
            case Contents.Type.CONTACT:
                ...
                if (contactBundle != null) {
                    ...
                    if (!encoded[1].isEmpty()) {
                        ...
                        title = "contents_contact";//activity.getString(R.string.contents_contact);
                    }
            ...
            case Contents.Type.LOCATION:
                ...
                if (locationBundle != null) {
                    ...
                    if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
                        ...
                        title = "contents_location";//activity.getString(R.string.contents_location);
                    }
                }
                break;
        }
