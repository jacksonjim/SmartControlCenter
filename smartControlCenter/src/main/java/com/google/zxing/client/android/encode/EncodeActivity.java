...
public final class EncodeActivity extends Activity {
    ...
    private void share() {
        ...
        if (!barcodesRoot.exists() && !barcodesRoot.mkdirs()) {
            ...
            showErrorMessage("Couldn't make dir " + barcodesRoot);//R.string.msg_unmount_usb);
            return;
        }
        ...
        try {
            ...
            showErrorMessage("Couldn't access file " + barcodeFile + " due to " + fnfe);//R.string.msg_unmount_usb);
            return;
        } finally {
            if (fos != null) {
                try {
    ...
    protected void onResume() {
        ...
        try {
            ...
            if (bitmap == null) {
                ...
                showErrorMessage("Could not encode barcode");//R.string.msg_encode_contents_failed);
                qrCodeEncoder = null;
                return;
            }
